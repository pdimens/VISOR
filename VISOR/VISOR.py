...
def main():
	...
	required.add_argument('-O','--output-format', help='output format for FASTQ files [10x] {choices: 10x, stlfr, haplotagging, tellseq}', metavar='', choices = ["10x", "stlfr", "haplotagging", "tellseq"])
